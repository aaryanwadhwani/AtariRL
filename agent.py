...
class Agent:
    ...
    def __init__(self, model, device='cpu', epsilon=1.0, min_epsilon=0.1, nb_warmup=10000, nb_actions=None, memory_capacity=10000, batch_size=32, learning_rate=0.00025, optimizer_state_dict=None):
    ...
    def train(self, env, epochs, batch_identifier=0, start_epoch=1, stats=None, game_name=None, game_config=None, resume_checkpoint_dir="models"):
        if stats is None:
        ...
        for epoch in range(start_epoch, epochs + 1):
            ...
            if epoch % 1000 == 0:
                ...
                if game_name is None:
                    game_name = batch_identifier if isinstance(batch_identifier, str) else "game"
                checkpoint_path = os.path.join(resume_checkpoint_dir, f"model_{game_name}_{epoch}.pt")
